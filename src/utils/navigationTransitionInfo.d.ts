...
export function normalizeNavigationTransitionInfo(info: NavigationTransitionInfo | null): NavigationTransitionInfo | null
export function parseNavigationTransitionInfo(value: string | null, fallback?: NavigationTransitionInfo): NavigationTransitionInfo | null

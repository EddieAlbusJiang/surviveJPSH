export default {
  ...
  'home.study.desc': 'Subject selection, study materials, mental health, study strategies',
  'home.life.desc': 'Teachers, rules, interpersonal relationships, parents, activities, tips',

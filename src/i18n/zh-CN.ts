export default {
  ...
  'about.contributing.desc': '欢迎各位在Github仓库提交 Issue 和 Pull Request 来帮助改进本项目。不熟悉Git工作流程的校友亦可发送邮件反馈。',
  'about.contributing.repo': 'surviveJPSH仓库地址：',
  'about.contributing.mail': '邮件地址：',
  'about.contributing.anymore': '更多信息参见Github仓库自述文件Readme.md',
  'doc.notFound': '文档未找到',
